...
public partial class ExercisesHistory : ContentPage
{
	public ExercisesHistory()
	{
        InitializeComponent();

        //List<string> vaje = new List<string>();
        //vaje = App.Database.GetOpravljeneVaje(sportnaOprema, ObremenjeneMisice, TezavnostVadbe, poskodbe);
